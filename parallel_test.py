...
def run_script_on_one_state(location_code, predict_from_dates, location_to_state, working_dir):
    ...
    with Pool() as pool:
        ...
        tasks = [(location_code, date, location_to_state, working_dir) for date in predict_from_dates["date"]]
...
def main():
    ...
    run_script_on_one_state("04", predict_from_dates, location_to_state, working_dir)
